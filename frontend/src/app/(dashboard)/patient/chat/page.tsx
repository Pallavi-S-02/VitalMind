...
import { Send, Sparkles, XCircle, Trash2, Bot } from "lucide-react";
    ...
    <div className="flex flex-col h-[calc(100vh-theme(spacing.16))] bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-shrink-0 px-6 py-4 border-b border-white/5 flex items-center justify-between bg-gray-900/50 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">VitalMind AI</h1>
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <span className="text-xs text-gray-400 font-medium">
                {isConnected ? "Connected • Medical Orchestrator Online" : "Disconnected • Reconnecting..."}
              </span>
            </div>
          </div>
        </div>
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in duration-500">
              ...
              <p className="text-gray-400 max-w-sm mb-8">
                I am your specialized medical orchestrator AI. I can check symptoms, review medications, or answer general health questions.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-lg">
                {[
                  ...
                  <button 
                    ...
                    className="px-4 py-3 bg-gray-800/40 hover:bg-gray-800/80 border border-white/5 rounded-xl text-sm text-gray-300 text-left transition-colors"
                  >
                    &quot;{suggestion}&quot;
                  </button>
                ))}
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="text-center mt-3">
            <p className="text-[11px] text-gray-600">
              VitalMind AI provides general information and does not replace professional medical advice.
            </p>
          </div>
        </div>
      </div>
